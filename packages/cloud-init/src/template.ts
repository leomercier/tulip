...
write_files:
  ...
  - path: /opt/tulip/bootstrap.sh
    ...
    content: |
      ...
      ExecStart=/usr/bin/docker run --name openclaw --env-file /opt/tulip/openclaw/.env -p 127.0.0.1:\${OPENCLAW_PORT}:18791 \${OPENCLAW_IMG} openclaw gateway --port 18791 --allow-unconfigured
